...
export const ATTEND_APPOINTMENT_REQUEST = 'ATTEND_APPOINTMENT_REQUEST';
export const ATTEND_APPOINTMENT_SUCCESS = 'ATTEND_APPOINTMENT_SUCCESS';
export const ATTEND_APPOINTMENT_FAILURE = 'ATTEND_APPOINTMENT_FAILURE';
